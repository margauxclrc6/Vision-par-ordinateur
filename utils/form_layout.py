...
These constants define where each field sits on the page as relative
coordinates (x_ratio, y_ratio, w_ratio, h_ratio).  They must be calibrated
on the actual form; the values below are reasonable starting points.

All coordinates are fractions of the page width/height so they remain
resolution-independent.
"""

# ── Page 1 fields (onglet PAGE-01) ────────────────────────────────────────────
...
# (left boundary of choice columns, row height, etc.)
EXAM_QUESTION_COL = (0.02, 0.10, 0.08, 0.80)   # question number column
EXAM_CHOICES_START_X = 0.12
EXAM_CHOICE_COL_W = 0.07
EXAM_ROW_START_Y = 0.10
EXAM_ROW_H = 0.06

# Handwritten numerical answer (mantissa + exponent)
